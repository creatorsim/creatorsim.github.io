 ...
 */
				...
				var uielto_register_double_popover = {
				...
				template:   	'<b-popover :target="target" triggers="click blur">' +
											...
											'            {{"0x"+ bin2hex(double2bin(register.value))}}' +
											'          </b-badge>' +
											'        </td>' +
											'      </tr>' +
											'      <tr>' +
				...
				Vue.component('popover-register-double', uielto_register_double_popover)
