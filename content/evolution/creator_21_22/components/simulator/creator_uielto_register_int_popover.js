 ...
 */
				...
				var uielto_register_int_popover = {
				...
				template:   	'<b-popover :target="target" ' +
											...
											'            {{"0x"+(((register.value).toString(16)).padStart(register.nbits/4, "0")).toUpperCase()}}' +
											'          </b-badge>' +
											'        </td>' +
											'      </tr>' +
											'      <tr>' +
											...
											'        <td>' +
											'          <b-badge class="registerPopover">' +
											'            {{(((register.value).toString(2)).padStart(register.nbits, "0"))}}' +
											'          </b-badge>' +
											'        </td>' +
											'      </tr>' +
											'      <tr>' +
											...
											'        <td>' +
											'          <b-badge class="registerPopover" ' +
											'                   v-if="(((register.value).toString(2)).padStart(register.nbits, \'0\')).charAt(0) == 1">' +
											'            {{parseInt(register.value.toString(10))-0x100000000}}' +
											'          </b-badge>' +
											'          <b-badge class="registerPopover"' +
											'                   v-if="(((register.value).toString(2)).padStart(register.nbits, \'0\')).charAt(0) == 0">' +
											...
											'        <td>' +
											'          <b-badge class="registerPopover">' +
											'            {{hex2char8((((register.value).toString(16)).padStart(register.nbits/4, "0")))}}' +
											'          </b-badge>' +
											'        </td>' +
											'      </tr>' +
											'      <tr>' +
											...
											'                @click="updateReg(component.index, register.name, architecture.components[component.index].type)">' +
											'        Update' +
											'      </b-button>' +
											'    </div>' +
											'  </div>' +
				...
				Vue.component('popover-register-int', uielto_register_int_popover)
